...
eqwqwe_CFLAGS = -fobjc-arc
eqwqwe_CCFLAGS = -std=c++11 -fno-rtti -fno-exceptions -DNDEBUG
...
eqwqwe_FILES = Tweak.xm $(MENU_SRC) $(KITTYMEMORY_SRC) $(SCLALERTVIEW_SRC)

eqwqwe_LIBRARIES += substrate

eqwqwe_FRAMEWORKS = $(PROJ_COMMON_FRAMEWORKS)
# GO_EASY_ON_ME = 1
